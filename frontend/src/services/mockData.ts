...
export const MOCK_PRODUCT_ORDERS: ProductOrder[] = [
  {
    id: 1, order_number: 'ORD-2024-0001', tracking_id: 'TRK-A1B2C3D4E5F6',
    product_name: 'Industrial Welding Rod', model: 'WB-7018',
    quantity: 500, customer_name: 'Tata Steel Ltd',
    customer_email: 'orders@tatasteel.com',
  ...
  {
    id: 2, order_number: 'ORD-2024-0002', tracking_id: 'TRK-G7H8I9J0K1L2',
    product_name: 'Alloy Filler Wire', model: 'WB-ER70S',
    quantity: 200, customer_name: 'Bharat Forge',
    customer_email: 'procurement@bharatforge.com',
  ...
  {
    id: 3, order_number: 'ORD-2024-0003', tracking_id: 'TRK-M3N4O5P6Q7R8',
    product_name: 'Flux Cored Wire', model: 'WB-E71T',
    quantity: 100, customer_name: 'Larsen & Toubro',
    customer_email: 'supply@lnt.com',
  ...
  {
    id: 4, order_number: 'ORD-2024-0004', tracking_id: 'TRK-S9T0U1V2W3X4',
    product_name: 'Submerged Arc Welding Flux', model: 'WB-SAF10',
    quantity: 50, customer_name: 'Godrej & Boyce',
    customer_email: 'purchase@godrej.com',
